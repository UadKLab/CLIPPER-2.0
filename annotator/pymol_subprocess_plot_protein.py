...
from clipper.visualize import get_pymol_image
from argparse import ArgumentParser, HelpFormatter

parser = ArgumentParser(
    prog="Pymol protein plotting subprocess",
    description="In order to remove info output from pymol during protein plotting, this script runs the process as a subprocess with stdout=DEVNULL",
